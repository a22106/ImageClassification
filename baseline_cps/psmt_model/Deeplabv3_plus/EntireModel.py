import torch.nn
from psmt_utils.losses import *
from itertools import chain
from psmt_base.base_model import BaseModel
from psmt_model.Deeplabv3_plus.encoder_decoder import *

res_net = "CityCode/Model/PSPNet/Backbones/pretrained/3x3resnet{}-imagenet.pth"
res_net_2 = "C:/Users/Admin/OneDrive/C Documents/GitHub/ImageClassification/baseline_cps/psmt_model/resnet{}.pth"
...
class EntireModel(BaseModel):
    def __init__(self, num_classes, config, sup_loss=None, cons_w_unsup=None, ignore_index=None,
        ...
        self.encoder1 = EncoderNetwork(num_classes=num_classes, norm_layer=nn.BatchNorm2d,
                                       pretrained_model=None, back_bone=101)
        self.decoder1 = DecoderNetwork(num_classes=num_classes, data_shape=[512,512])
        self.encoder2 = EncoderNetwork(num_classes=num_classes, norm_layer=nn.BatchNorm2d,
                                       pretrained_model=None, back_bone=101)
        self.decoder2 = DecoderNetwork(num_classes=num_classes, data_shape=[512,512])
        self.encoder_s = EncoderNetwork(num_classes=num_classes, norm_layer=nn.BatchNorm2d,
                                        pretrained_model=res_net_2.format(str(101)),
                                        back_bone=101)
        self.decoder_s = VATDecoderNetwork(num_classes=num_classes, data_shape=[512,512])
        self.mode = "semi"
